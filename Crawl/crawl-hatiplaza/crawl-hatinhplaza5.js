...
(async () => {
  try {
    const fileName = 'hatiplaza5.xlsx';
    ...
    for (let pageIndex = 1; pageIndex <= totalPages; pageIndex++) {
      let url = `https://hatiplaza.com/mua-sam/danh-muc/thuc-pham-che-bien_168/?sort_by=newest&page=${pageIndex}`;
      ...
      for (let item of pageData) {
        ...
        while (retries > 0 && !success) {
          try {
            ...
            await page.goto(item.detailURL, { waitUntil: 'networkidle2', timeout: 120000 });

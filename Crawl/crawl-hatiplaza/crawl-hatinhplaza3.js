...
(async () => {
  try {
    const fileName = 'hatiplaza3.xlsx';
    ...
    for (let pageIndex = 1; pageIndex <= totalPages; pageIndex++) {
      let url = `https://hatiplaza.com/mua-sam/danh-muc/san-pham-tieu-bieu_191/?sort_by=newesthttps%3A%2F%2Fhatiplaza.com%2Fmua-sam%2Fdanh-muc%2Fsan-pham-tieu-bieu_191%2F%3Fsort_by%3Dnewest&page=${pageIndex}`;
